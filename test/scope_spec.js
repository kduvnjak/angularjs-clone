...
describe('Scope', function () {
    ...
    describe('digest', function () {
        ...
        it('call listener when watch value if first undefine', function () {
            scope.counter = 0;
            scope.$watch(function (scope) {
                return scope.someValue;
            }, function (newValue, oldValue, scope) {
        ...
        it('compares bassed on value if enabled', function () {
            scope.array = [1, 2, 3];
            scope.counter = 0;
        ...
        it('catcher exception in watch function and continues', function () {
            scope.aValue = 'abc';
            scope.counter = 0;
        ...
        it('catches exception in listener function and continues', function () {
            scope.aValue = 'abc';
            scope.counter = 0;
        ...
        it('has a $$phase field whose value is the current digest phase', function () {
            ...
            scope.phaseInListenerFunctioon = undefined;
            ...
            scope.$watch(function (scope) {
                ...
                scope.phaseInListenerFunctioon = scope.$$phase;
            });
            ...
            expect(scope.phaseInListenerFunctioon).toBe('$digest');
    ...
    describe('$apply', function () {
        ...
        it('executes the given function and start the digest', function () {
    ...
    describe('$evalAsnyc', function () {
        ...
        it('executes $evalAsynced function added by watch function', function () {
            scope.aValue = [1, 2, 3];
            scope.asyncEvaluated = false;
        ...
        it('executed $evalAsynced functions even when not dirty', function () {
            scope.aValue = [1, 2, 3];
    ...
    describe('$$postDigest', function () {
        ...
        it('does not include $$postDigest in digest', function () {
            ...
            scope.$digest();
            expect(scope.watchedValue).toEqual('original value');

            scope.$digest();
            expect(scope.watchedValue).toEqual('changed value');
        });
    ...
    describe('$watchGroup', function () {
        ...
        it('calss the listener once when the watch array is empty', function () {
            var gotNewValues, gotOldValues;
    ...
    describe('inheritance', function () {
        ...
        it('does not have access to parent scope when isolated', function () {
            var parent = new Scope();
        ...
        it('can not watch parent properties when isolated', function () {
            var parent = new Scope();
            var child = parent.$new(true);
        ...
        it('schedules a digest form root on $evalAsync when isolated', function (done) {
            var parent = new Scope();
            var child = parent.$new(true);
            var child2 = child.$new();
    ...
    describe('$watchCollection', function () {
        ...
        it('notices an item removed from array', function () {
            scope.arr = [1, 2, 3];
            scope.counter = 0;
        ...
        it('notices an item replaced in array', function () {
            scope.arr = [1, 2, 3];
            scope.counter = 0;
        ...
        it('notices object replaced in arguments object', function () {
            (function () {
        ...
        it('noties when an attribute is changed in an object', function () {
            scope.counter = 0;
            scope.obj = {a: 1};
            scope.$watchCollection(function (scope) {
                return scope.obj;
        ...
        it('notices when an attribute is removed from object', function () {
            scope.counter = 0;
            scope.obj = {a: 1};
        ...
        it('does not consider any object with length property array', function () {
    ...
    describe('Events', function () {
        ...
        it('registers different listenrs for every scope', function () {
            var listener1 = function () {
            };
            var listener2 = function () {
            };
